...
namespace KulibinSpace.DamageSystem {
    ...
    public abstract class DamageReceiver : MonoBehaviour {
        ...
        [SerializeField]
        protected float durability = 2000f; // 12:27 07.06.2019 Размерность совпадает с величиной получаемого импульса при ударе. уменьшается при попаданиях, при обнулении объект уничтожается
